...
const AddUser = () => {
    ...
    const send = async () => {
        ...
        try {
            ...
            const response = await axios.post("http://localhost:8050/users/add", newUserForm)
        ...
        return (
            <div className="row">
                ...
                {userAdded
                    ? <h2>User a été rajouté correctement</h2>
                    : <>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" onChange={(event) =>
                                ...
                                class="form-control" name="name" placeholder="Nom d'user" />
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" onChange={(event) =>
                                ...
                                class="form-control" name="new-image" />
                        </div>
                        <div class="mb-3">
